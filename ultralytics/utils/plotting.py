...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        self.lw = line_width or max(round(sum(im.size if input_is_pil else im.shape) / 2 * 0.002), 1)
        if self.pil:  # use PIL
        ...
        self.limb_color = colors.pose_palette[[9, 9, 0, 0, 0, 0, 0, 0, 0, 16, 16, 16, 16, 16]]
        # self.kpt_color = colors.pose_palette[[16, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9]]
        self.kpt_color = colors.pose_palette[[9, 0, 0, 0, 0, 0, 0, 16, 16, 16, 16, 16, 16]]
        self.dark_colors = {
            (235, 219, 11),
            (243, 243, 243),
            (183, 223, 0),
    ...
    def kpts(self, kpts, shape=(640, 640), radius=None, kpt_line=True, conf_thres=0.25, kpt_color=None):
        ...
        is_pose = nkpt == 13 and ndim in {2, 3}  # 原本是17
